...
<?php 
if ($_SESSION['user_role'] !="Admin" AND $_SESSION['user_role'] !="Report" AND $_SESSION['user_role'] !="Maintenance") {
...
<div class="preloader">
    ...
    <main class="main-content">
        ...
        <div class="placeholder mt-3">
           ...
           <?php include('includes/report_content.php') ?>
        </div>
    </main>
...
<?php include('includes/external_js.php');
 ...
 ?>
    ...
    //    <script type="text/javascript" src="js/proper.js"></script>
        ...
        <script type="text/javascript" src="js/maintenence_report.js"></script>
