...
<div class="preloader">
    ...
    <main class="main-content">
           ...
           <?php include('includes/sub_unit_content.php') ?>
            </div>
    </main>
...
<?php include('includes/external_js.php');
 ...
 ?>
    ...
    //    <script type="text/javascript" src="js/proper.js"></script>
        ...
        <script type="text/javascript" src="js/sub_unit.js"></script>
        <script type="text/javascript" src="js/add_sub_unit.js"></script>
