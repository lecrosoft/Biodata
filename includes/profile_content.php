...
<div class="d-sm-flex align-items-center justify-content-between mb-4" id="page_title">
    <h1 class="h3 mb-0 text-gray-800">Profile From <span style="font-size:21px;color:blue;font-weight:bold">20-10-2023</span> To <span style="font-size:21px;color:blue;font-weight:bold">20-10-2023</span></h1>
