$(document).ready(function () {
            ...
            if (type === "display") {
              data = `          <div class="dropdown no-arrow">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                                                                          ...
                                                                          <a class="dropdown-item  passwordBtn" id=${row.user_id}><i class="fas fa-lock fa-sm fa-fw mr-2 text-gray-400"></i>Change Password</a>
  ...
  tableClass.addEventListener("click", function (e) {
    ...
    if (clickedBtn.classList.contains("editBtn")) {
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          document.querySelector("#userModalLabel").textContent = "Edit User";
          ...
          document.querySelector(".password-div").style.display = 'none';
    ...
    if (clickedBtn.classList.contains("passwordBtn")) {
      e.preventDefault();
      // $("#editReportCardModal").modal("show");
     userId = clickedBtn.getAttribute("id");
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          document.querySelector("#userModalLabel").textContent = "Edit User";
          saveBtnUpdate.textContent = "Update";
          document.querySelector("#password_user_id").value = response[0].user_id;
   

          formMethod = "PUT-PASSWORD";
          loadForm(formMethod);
