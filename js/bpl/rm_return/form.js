...
let content = $(` <div class="contain">
                        <div class="return"><h3>Raw Materials Return</h3></div>
                    </div>
                    <div class="container">
                ...
                //     return false
                    ...
                    if(res.status){
                        if(props === "Partial"){
                            ...
                            document.getElementById('Save').disabled = true
                            saveProps(res.data.weight,res.data.barcode,res.data.productname);
                    }
                    else{
                        Swal.fire(
                            'Error!',
    ...
    function saveProps(oldweight,barcode,productname){
        document.querySelector('.saveProp').addEventListener('click',function(e){
           ...
           let company_id =  document.getElementById('company_id').value;
            ...
            fetch('app/rawmaterials_return/savereturn',{
                method:'POST',
                headers:{
                    'Content-type':'application/json'
                },
