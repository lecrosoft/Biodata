...
function selecter (input) {
    $(input).select2({ theme: "bootstrap4" })
}
...
function salesOrder(param = null) {
    ...
    let $order = (param) ? `value="${param.orderid}"` : '',
        ...
        $unable = (param) ? param.delivery === 1 : 0
                ...
                <form class="submit-disabled" id="order" data-id="${(param) ? param.orderid : null}">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4 col-lg-2">
                            ...
                            <select name="location" id="location" class="bg-light form-control form-control-sm col-lg-11" required ${($unable) ? 'disabled' : ''}>
                        ...
                        <div class="form-group col-md-7 col-lg-4">
                            ...
                            <select name="customer" id="customer" class="bg-light form-control form-control-sm col-lg-11 select2" required>
    ...
    for ( let i = 0; i <= $count - 1; i++ ) {
        let $qty = (param) ? `value="${param.details[i].quantityordered}"` : '',
            ...
            $disabled = (param && param.details[i].delivery === '1') ? 'disabled' : ''
        ...
        container.find('tbody').append(`
            <tr ${(param) ? `class="filled" data-item="${item}"` : ''}>
                ...
                <td class="w-25"><input type="number" class="bg-light form-control form-control-sm col-lg-10 mx-auto" name="quantity" id="quantity" min="1" ${$qty} ${$disabled}></td>
    ...
    resolver( warehouse, data => {
        for (res of data) {
                let $selected = (param && param.warehouselocation === res.warehouselocation) ? 'selected' : ''
